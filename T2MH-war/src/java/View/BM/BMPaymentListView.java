 ...
 * @author 19319
 */
@Named(value = "bmPaymentListView")
@ManagedBean
@ViewScoped
public class BMPaymentListView implements Serializable {
    ...
    public void init() {
        ...
        List<Payment> listPayment = (List<Payment>) bm.getBranchID().getPaymentCollection();
        lazyModel = new LazyPaymentDataModel(listPayment);
    }
    ...
    public class LazyPaymentDataModel extends LazyDataModel<Payment> {
        ...
        public List<Payment> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
            ...
            if (sortField != null) {
                try {
                    Collections.sort(data, new BMPaymentListView.LazySorter(sortField, sortOrder));
                } catch (Exception e) {
                    ...
                    Collections.sort(B, new BMPaymentListView.LazySorterInverseFields(sortField, sortOrder));
